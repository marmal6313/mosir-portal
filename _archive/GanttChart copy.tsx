            ...
            <div className="min-w-full" style={{ width: chartWidth + 200 }}>
              ...
              <div className="sticky top-0 bg-gray-50 border-b border-gray-200">
                <div className="flex" style={{ paddingLeft: '200px' }}>
                  {timeAxisLabels.map((label, index) => (
                    <div
                      key={index}
                      className="border-l border-gray-200 text-xs text-gray-600 text-center py-2"
              ...
              <div className="relative">
                {taskPositions.map((task, index) => (
                  ...
                  >
                    {/* Task Info */}
                    <div className="sticky left-0 bg-white border-r border-gray-200 px-4 py-2 min-w-[200px] z-10">
                    ...
                    <div className="relative flex-1" style={{ height: '60px' }}>
                      <div
                        className="absolute top-1/2 transform -translate-y-1/2 rounded-md cursor-pointer transition-all hover:shadow-md"
                        style={{
                          left: `${task.left}px`,
                          width: `${task.width}px`,
                          height: '24px',
